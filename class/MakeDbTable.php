...
abstract class MakeDbTable {
	 ...
	 * @var array
	 */
	protected $_tablePrefixes = array('tbl_', 'tbl', 't_', 'table', 'tb', 'tba', 'tba_', 'tbx');
	...
	function makeDbTableFile() {
        ...
        /**
	 * creates the Controller class file
	 */
	...
	function makeFormFile() {
		...
		$mapperFile=$this->getLocation().DIRECTORY_SEPARATOR.'Forms'.DIRECTORY_SEPARATOR.$this->_className.'.php';

		$mapperData=$this->getParsedTplContents('form.tpl');

		if (!file_put_contents($mapperFile,$mapperData)) {
			die("Error: could not write form file $mapperFile.");
		}
	}
